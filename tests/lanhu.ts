...
console.log(getDownloadParamsByUrl(url1, { type: EnumUrlType.project, }, { teamId: '' }));

console.log(getDownloadParamsByUrl(url1, { type: EnumUrlType.sector, sectorName: "未分组", , { teamId: '' }));

console.log(getDownloadParamsByUrl(url1, { type: EnumUrlType.image, }, { teamId: '' }));
